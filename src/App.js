...
class App extends React.Component {
  constructor() {
    ...
    this.state = {
      ...
      listOfCuACResistances: [
        { num14: { PVC: 3.1, Al: 3.1, steel: 3.1 } },
        { num12: { PVC: 2, Al: 2, steel: 2 } },
      ],
      listOfAlACResistances: [
        { num14: { PVC: 3.2, Al: 3.2, steel: 3.2 } },
        { num12: { PVC: 2, Al: 2, steel: 2 } },
      ],
      infoFromForm: {
        wireTag: "",
  ...
  calcImp(resist, react, pf) {
    // impedance = (Resistance * cos(arcos(pf)))+(Reactance * sin(arcsin(pf)))
  }
